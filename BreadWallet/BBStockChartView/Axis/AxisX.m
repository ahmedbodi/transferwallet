...
//            NSLog(@"Draw x: %d", i);
            ...
            CALayer* transfer = [BaseLayer layerOfLineFrom:CGPointMake(idxWidth/2, 0) to:CGPointMake(idxWidth/2, 5) withColor:[BBTheme theme].axisColor andWidth:1];
            transfer.anchorPoint = CGPointZero;
            transfer.position = CGPointMake(idxWidth*i, 1);
            [self addSublayer:transfer];
        }
