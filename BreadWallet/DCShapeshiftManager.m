...
////////////////////////////////////////////////////////////////////
/*
 url: shapeshift.io/marketinfo/transfer_btc
 method: GET
...
-(void)GET_marketInfo:(void (^)(NSDictionary *marketInfo, NSError *error))completionBlock {
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"https://shapeshift.io/marketinfo/transfer_btc"]
    ...
    [NSURLConnection sendAsynchronousRequest:request queue:[NSOperationQueue currentQueue]
                           completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
                               if (((((NSHTTPURLResponse*)response).statusCode /100) != 2) || connectionError) {
                                   ...
                                   if (!returnError) {
                                       returnError = [NSError errorWithDomain:@"TransferWallet" code:((NSHTTPURLResponse*)response).statusCode userInfo:nil];
                                   }
...
-(void)POST_ShiftWithAddress:(NSString*)withdrawalAddress returnAddress:(NSString*)returnAddress completionBlock:(void (^)(NSDictionary *shiftInfo, NSError *error))completionBlock {
    NSDictionary *params = @{@"withdrawal": withdrawalAddress, @"pair": @"transfer_btc", @"returnAddress":returnAddress,@"apiKey":SHAPESHIFT_PUBLIC_KEY};
                           ...
                           completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
                               ...
                               dispatch_async(dispatch_get_main_queue(), ^{
                                   if ([dictionary objectForKey:@"error"]) {
                                       completionBlock(nil,[NSError errorWithDomain:@"TransferWallet" code:500 userInfo:@{NSLocalizedDescriptionKey:[dictionary objectForKey:@"error"]
                                                                                                                      }]);
                                   } else {
                                       completionBlock(dictionary,nil);
                                   }
...
-(void)POST_SendAmount:(NSNumber*)amount withAddress:(NSString*)withdrawalAddress returnAddress:(NSString*)returnAddress completionBlock:(void (^)(NSDictionary *shiftInfo, NSError *error))completionBlock {
    NSDictionary *params = @{@"amount":amount,@"withdrawal": withdrawalAddress, @"pair": @"transfer_btc", @"returnAddress":returnAddress,@"apiKey":SHAPESHIFT_PUBLIC_KEY};
